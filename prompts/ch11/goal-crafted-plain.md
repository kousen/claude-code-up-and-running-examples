The weather app's city page matches the Night Sky mockup in design/DirectionA.dc.html (its commitments are the note-a entry in design/canvas.json), and every item below is proven by command output shown in this session:
