# Chapters 6 and 8 MockHub Artifacts

Chapter 6 ("Skills and Hooks") uses the PR-readiness skill here; Chapter 8
...
the agents support the Chapter 8 material. The MockHub application code lives in
its own repository:
